...
def main(opt):
    ...
    cmd = "valgrind --tool=massif --stacks=yes --massif-out-file=valgrind-output/massif-output-riot.txt --fullpath-after=/home/phantom/CP_Systems/RTOS/RIOT/ --read-var-info=yes /home/phantom/CP_Systems/Implementations/WMNLoRa/bin/native/stack_test.elf /dev/ttyACM0"
    os.system(cmd)
